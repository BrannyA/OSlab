...
struct task_info task2_1 = {(uint32_t)&printk_task1, USER_PROCESS};
struct task_info task2_2 = {(uint32_t)&printk_task2, USER_PROCESS};
struct task_info task2_3 = {(uint32_t)&drawing_task1, USER_PROCESS};
